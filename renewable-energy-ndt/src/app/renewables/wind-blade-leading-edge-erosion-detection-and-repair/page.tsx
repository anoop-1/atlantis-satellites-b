...
export const metadata: Metadata = {
  title: "Wind Blade Leading Edge Erosion: Detection and Repair",
  description: "Working notes for wind on leading edge erosion: how to choose the technique, document the decision, and survive the next audit.",
  keywords: ["leading edge erosion","wind blade LEE","blade repair","leading edge protection"],
  alternates: { canonical: "https://renewable-energy-ndt.vercel.app/renewables/wind-blade-leading-edge-erosion-detection-and-repair" },
  openGraph: {
    title: "Wind Blade Leading Edge Erosion: Detection and Repair",
    description: "Working notes for wind on leading edge erosion: how to choose the technique, document the decision, and survive the next audit.",
    type: 'article',
    url: "https://renewable-energy-ndt.vercel.app/renewables/wind-blade-leading-edge-erosion-detection-and-repair",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Wind Blade Leading Edge Erosion: Detection and Repair",
  "description": "Working notes for wind on leading edge erosion: how to choose the technique, document the decision, and survive the next audit.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://renewable-energy-ndt.vercel.app/renewables/wind-blade-leading-edge-erosion-detection-and-repair"
  },
  "keywords": "leading edge erosion, wind blade LEE, blade repair, leading edge protection"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Wind Blade Leading Edge Erosion: Detection and Repair</span>
      </nav>
      <h1>Wind Blade Leading Edge Erosion: Detection and Repair</h1>
      <p className="text-sm text-gray-500 mb-8">By Sven Mortensen, IIMS &middot; Published 2026-04-21</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions wind, solar, hydrogen, and geothermal NDT engineers need to make when working on renewable energy NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of leading edge erosion that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any wind how often leading edge erosion drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most leading edge erosion programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any leading edge erosion engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to leading edge erosion usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible leading edge erosion report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of leading edge erosion should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize leading edge erosion in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How leading edge erosion fits into the bigger picture</h3>
<p>It is easy to study leading edge erosion as an isolated subject — most courses do exactly that — but the engineering value only appears when you place leading edge erosion alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.api.org/products-and-services/individual-certification-programs" rel="noopener nofollow">the API individual certification program overview</a> to align their practice with what is already published in the wider community. For most wind the question is not "what is leading edge erosion?" but "where does leading edge erosion sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in leading edge erosion, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on wind blade LEE</h3>
<p>Three behaviours we see at high-performing operators consistently show up in wind blade LEE programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a wind blade LEE program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best blade repair documentation packages we have seen share three patterns:</p>
<ul>
...
<p>leading edge protection engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
