...
export const metadata: Metadata = {
  title: "Class Location Changes, MOP, and the Inspector Implications",
  description: "A field-oriented walkthrough of class location for pipeline integrity engineers, with decision matrices, code references, and the documentation auditors ac...",
  keywords: ["class location","MOP pipeline","class 1 to class 3","pipeline class location"],
  alternates: { canonical: "https://pipeline-integrity-guide.vercel.app/case-studies/class-location-changes-mop-and-the-inspector-implications" },
  openGraph: {
    title: "Class Location Changes, MOP, and the Inspector Implications",
    description: "A field-oriented walkthrough of class location for pipeline integrity engineers, with decision matrices, code references, and the documentation auditors ac...",
    type: 'article',
    url: "https://pipeline-integrity-guide.vercel.app/case-studies/class-location-changes-mop-and-the-inspector-implications",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Class Location Changes, MOP, and the Inspector Implications",
  "description": "A field-oriented walkthrough of class location for pipeline integrity engineers, with decision matrices, code references, and the documentation auditors ac...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pipeline-integrity-guide.vercel.app/case-studies/class-location-changes-mop-and-the-inspector-implications"
  },
  "keywords": "class location, MOP pipeline, class 1 to class 3, pipeline class location"
};
...
<ul>
<li><strong>The decision points</strong> that drive most class location programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any class location engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of class location should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize class location in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/erp/inventory-management-ndt-inspection-companies-hyderabad" rel="noopener">Atlantis NDT's inventory management ndt inspection companies hyderabad ERP write-up</a> to align their practice with what is already published in the wider community.</p><h3>How class location fits into the bigger picture</h3>
<p>It is easy to study class location as an isolated subject — most courses do exactly that — but the engineering value only appears when you place class location alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.imca-int.com/" rel="noopener nofollow">the IMCA technical resources for offshore work</a> to align their practice with what is already published in the wider community. For most pipeline integrity engineers the question is not "what is class location?" but "where does class location sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in class location, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on MOP pipeline</h3>
<p>Three behaviours we see at high-performing operators consistently show up in MOP pipeline programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a MOP pipeline program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best class 1 to class 3 documentation packages we have seen share three patterns:</p>
<ul>
