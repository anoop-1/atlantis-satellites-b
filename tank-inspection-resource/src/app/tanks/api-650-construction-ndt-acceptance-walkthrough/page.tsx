...
export const metadata: Metadata = {
  title: "API 650 Construction NDT Acceptance: A Walkthrough",
  description: "A field-oriented walkthrough of API 650 NDT for API 653 inspectors, with decision matrices, code references, and the documentation auditors actually want.",
  keywords: ["API 650 NDT","tank construction","tank shell welding","API 650 acceptance"],
  alternates: { canonical: "https://tank-inspection-resource.vercel.app/tanks/api-650-construction-ndt-acceptance-walkthrough" },
  openGraph: {
    title: "API 650 Construction NDT Acceptance: A Walkthrough",
    description: "A field-oriented walkthrough of API 650 NDT for API 653 inspectors, with decision matrices, code references, and the documentation auditors actually want.",
    type: 'article',
    url: "https://tank-inspection-resource.vercel.app/tanks/api-650-construction-ndt-acceptance-walkthrough",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "API 650 Construction NDT Acceptance: A Walkthrough",
  "description": "A field-oriented walkthrough of API 650 NDT for API 653 inspectors, with decision matrices, code references, and the documentation auditors actually want.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://tank-inspection-resource.vercel.app/tanks/api-650-construction-ndt-acceptance-walkthrough"
  },
  "keywords": "API 650 NDT, tank construction, tank shell welding, API 650 acceptance"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>API 650 Construction NDT Acceptance: A Walkthrough</span>
      </nav>
      <h1>API 650 Construction NDT Acceptance: A Walkthrough</h1>
      <p className="text-sm text-gray-500 mb-8">By Heidi Knaack, API 653 &middot; Published 2025-12-15</p>
