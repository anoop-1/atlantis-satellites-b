...
export const metadata: Metadata = {
  ...
  description: "Practical guide for upstream/midstream/downstream inspection leads: how to apply API 653 in real inspection work, what auditors expect, and where most prog...",
  keywords: ["API 653","crude tank inspection","aboveground storage tank","tank floor inspection"],
  alternates: { canonical: "https://oil-gas-inspection-guide.vercel.app/sectors/crude-oil-storage-tank-inspection-api-653-walkthrough" },
  openGraph: {
    title: "Crude Oil Storage Tank Inspection: API 653 Walkthrough",
    description: "Practical guide for upstream/midstream/downstream inspection leads: how to apply API 653 in real inspection work, what auditors expect, and where most prog...",
    type: 'article',
    url: "https://oil-gas-inspection-guide.vercel.app/sectors/crude-oil-storage-tank-inspection-api-653-walkthrough",
    siteName: "Oil & Gas Inspection Guide",
    locale: 'en_US',
    publishedTime: "2025-02-25T00:00:00.000Z",
    modifiedTime: "2025-02-25T00:00:00.000Z",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Crude Oil Storage Tank Inspection: API 653 Walkthrough",
  "description": "Practical guide for upstream/midstream/downstream inspection leads: how to apply API 653 in real inspection work, what auditors expect, and where most prog...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://oil-gas-inspection-guide.vercel.app/sectors/crude-oil-storage-tank-inspection-api-653-walkthrough"
  },
  "keywords": "API 653, crude tank inspection, aboveground storage tank, tank floor inspection"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Crude Oil Storage Tank Inspection: API 653 Walkthrough</span>
      </nav>
      <h1>Crude Oil Storage Tank Inspection: API 653 Walkthrough</h1>
      <p className="text-sm text-gray-500 mb-8">By Ricardo Sosa, PE &middot; Published 2025-02-25</p>
...
<p>Ask any upstream/midstream/downstream inspection leads how often api 653 drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<p>If we had to summarize api 653 in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How API 653 fits into the bigger picture</h3>
<p>It is easy to study API 653 as an isolated subject — most courses do exactly that — but the engineering value only appears when you place API 653 alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.aws.org/standards" rel="noopener nofollow">the AWS standards catalog</a> to align their practice with what is already published in the wider community. For most upstream/midstream/downstream inspection leads the question is not "what is API 653?" but "where does API 653 sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
...
<h3>Operator behaviours that actually move the needle on crude tank inspection</h3>
<p>Three behaviours we see at high-performing operators consistently show up in crude tank inspection programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a crude tank inspection program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best aboveground storage tank documentation packages we have seen share three patterns:</p>
<ul>
...
<p>tank floor inspection engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
