...
export const metadata: Metadata = {
  title: "Subsea Manifold Anode Program Design and Inspection",
  description: "Subsea Manifold Anode Program Design and Inspection explained for subsea engineers — covering subsea manifold, common pitfalls, and the data your audit pac...",
  keywords: ["subsea manifold","sacrificial anode","anode design subsea","DNV anode"],
  alternates: { canonical: "https://subsea-inspection-guide.vercel.app/deepwater/subsea-manifold-anode-program-design" },
  openGraph: {
    title: "Subsea Manifold Anode Program Design and Inspection",
    description: "Subsea Manifold Anode Program Design and Inspection explained for subsea engineers — covering subsea manifold, common pitfalls, and the data your audit pac...",
    type: 'article',
    url: "https://subsea-inspection-guide.vercel.app/deepwater/subsea-manifold-anode-program-design",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Subsea Manifold Anode Program Design and Inspection",
  "description": "Subsea Manifold Anode Program Design and Inspection explained for subsea engineers — covering subsea manifold, common pitfalls, and the data your audit pac...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://subsea-inspection-guide.vercel.app/deepwater/subsea-manifold-anode-program-design"
  },
  "keywords": "subsea manifold, sacrificial anode, anode design subsea, DNV anode"
};
...
<ul>
<li><strong>The decision points</strong> that drive most subsea manifold programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any subsea manifold engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Post-repair inspection is the most procedural of the three patterns and the most likely to be weakened by schedule pressure. The required NDT is usually defined by the original construction code (ASME VIII, ASME XI, AWS D1.1, and so on), which is fine — but the decision about <em>how</em> to apply it under field conditions is rarely covered. Practical teams often cross-reference <a href="https://atlantisndt.com/consulting/fitness-for-service-api-579" rel="noopener">Level III consulting coverage in fitness for service api 579</a> to align their practice with what is already published in the wider community.</p><h2>The data the audit will ask for</h2>
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible subsea manifold report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of subsea manifold should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize subsea manifold in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/compare/atlantis-dt-vs-microsoft-azure-digital-twins" rel="noopener">Atlantis NDT's atlantis dt vs microsoft azure digital twins write-up</a> to align their practice with what is already published in the wider community.</p><h3>How subsea manifold fits into the bigger picture</h3>
<p>It is easy to study subsea manifold as an isolated subject — most courses do exactly that — but the engineering value only appears when you place subsea manifold alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">NRC operating experience reports</a> to align their practice with what is already published in the wider community. For most subsea engineers the question is not "what is subsea manifold?" but "where does subsea manifold sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in subsea manifold, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on sacrificial anode</h3>
<p>Three behaviours we see at high-performing operators consistently show up in sacrificial anode programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a sacrificial anode program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best anode design subsea documentation packages we have seen share three patterns:</p>
<ul>
