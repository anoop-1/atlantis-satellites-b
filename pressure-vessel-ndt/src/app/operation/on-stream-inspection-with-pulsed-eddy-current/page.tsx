...
export const metadata: Metadata = {
  title: "On-Stream Vessel Inspection With Pulsed Eddy Current: Where It Actually Works",
  description: "On-Stream Vessel Inspection With Pulsed Eddy Current explained for API 510 inspectors — covering pulsed eddy current, common pitfalls, and the data your au...",
  keywords: ["pulsed eddy current","PEC vessel","on-stream inspection PEC","CUI PEC"],
  alternates: { canonical: "https://pressure-vessel-ndt.vercel.app/operation/on-stream-inspection-with-pulsed-eddy-current" },
  openGraph: {
    title: "On-Stream Vessel Inspection With Pulsed Eddy Current: Where It Actually Works",
    description: "On-Stream Vessel Inspection With Pulsed Eddy Current explained for API 510 inspectors — covering pulsed eddy current, common pitfalls, and the data your au...",
    type: 'article',
    url: "https://pressure-vessel-ndt.vercel.app/operation/on-stream-inspection-with-pulsed-eddy-current",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "On-Stream Vessel Inspection With Pulsed Eddy Current: Where It Actually Works",
  "description": "On-Stream Vessel Inspection With Pulsed Eddy Current explained for API 510 inspectors — covering pulsed eddy current, common pitfalls, and the data your au...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://pressure-vessel-ndt.vercel.app/operation/on-stream-inspection-with-pulsed-eddy-current"
  },
  "keywords": "pulsed eddy current, PEC vessel, on-stream inspection PEC, CUI PEC"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>On-Stream Vessel Inspection With Pulsed Eddy Current: Where It Actually Works</span>
      </nav>
      <h1>On-Stream Vessel Inspection With Pulsed Eddy Current: Where It Actually Works</h1>
      <p className="text-sm text-gray-500 mb-8">By Vikram Sahota, Welding Engineer &middot; Published 2025-08-23</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions API 510 inspectors, fixed-equipment engineers, OEM QA leads need to make when working on pressure vessel inspection. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of pulsed eddy current that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any API 510 inspectors how often pulsed eddy current drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most pulsed eddy current programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any pulsed eddy current engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to pulsed eddy current usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible pulsed eddy current report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of pulsed eddy current should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize pulsed eddy current in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/ndt-consulting-fort-saskatchewan" rel="noopener">Atlantis NDT's ndt consulting fort saskatchewan resource</a> to align their practice with what is already published in the wider community. Practical teams often cross-reference <a href="https://atlantisndt.com/blog/digital-twin-roadmap-oil-gas-companies-asset-integrity" rel="noopener">the digital twin roadmap for oil & gas asset integrity</a> to align their practice with what is already published in the wider community.</p><h3>How pulsed eddy current fits into the bigger picture</h3>
...
<h3>Operator behaviours that actually move the needle on PEC vessel</h3>
<p>Three behaviours we see at high-performing operators consistently show up in PEC vessel programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a PEC vessel program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best on-stream inspection PEC documentation packages we have seen share three patterns:</p>
<ul>
...
<h3>How PEC vessel fits into the bigger picture</h3>
<p>It is easy to study PEC vessel as an isolated subject — most courses do exactly that — but the engineering value only appears when you place PEC vessel alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.nrc.gov/reactors/operating/ops-experience.html" rel="noopener nofollow">NRC operating experience reports</a> to align their practice with what is already published in the wider community. For most API 510 inspectors the question is not "what is PEC vessel?" but "where does PEC vessel sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in PEC vessel, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
