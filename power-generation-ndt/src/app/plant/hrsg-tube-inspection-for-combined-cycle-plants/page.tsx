...
export const metadata: Metadata = {
  title: "HRSG Tube Inspection for Combined Cycle Plants",
  description: "HRSG Tube Inspection for Combined Cycle Plants explained for power station inspection engineers — covering HRSG inspection, common pitfalls, and the data y...",
  keywords: ["HRSG inspection","heat recovery steam generator","combined cycle","HRSG tubes"],
  alternates: { canonical: "https://power-generation-ndt.vercel.app/plant/hrsg-tube-inspection-for-combined-cycle-plants" },
  openGraph: {
    title: "HRSG Tube Inspection for Combined Cycle Plants",
    description: "HRSG Tube Inspection for Combined Cycle Plants explained for power station inspection engineers — covering HRSG inspection, common pitfalls, and the data y...",
    type: 'article',
    url: "https://power-generation-ndt.vercel.app/plant/hrsg-tube-inspection-for-combined-cycle-plants",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "HRSG Tube Inspection for Combined Cycle Plants",
  "description": "HRSG Tube Inspection for Combined Cycle Plants explained for power station inspection engineers — covering HRSG inspection, common pitfalls, and the data y...",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://power-generation-ndt.vercel.app/plant/hrsg-tube-inspection-for-combined-cycle-plants"
  },
  "keywords": "HRSG inspection, heat recovery steam generator, combined cycle, HRSG tubes"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>HRSG Tube Inspection for Combined Cycle Plants</span>
      </nav>
      <h1>HRSG Tube Inspection for Combined Cycle Plants</h1>
      <p className="text-sm text-gray-500 mb-8">By Halvar Strøm, EPRI-certified &middot; Published 2025-05-24</p>
