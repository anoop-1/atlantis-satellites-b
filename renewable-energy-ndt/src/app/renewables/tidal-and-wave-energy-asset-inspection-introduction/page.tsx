...
export const metadata: Metadata = {
  title: "Tidal and Wave Energy Asset Inspection: An Introduction",
  description: "Practical guide for wind: how to apply tidal energy NDT in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["tidal energy NDT","wave energy inspection","marine renewable","MRE inspection"],
  alternates: { canonical: "https://renewable-energy-ndt.vercel.app/renewables/tidal-and-wave-energy-asset-inspection-introduction" },
  openGraph: {
    title: "Tidal and Wave Energy Asset Inspection: An Introduction",
    description: "Practical guide for wind: how to apply tidal energy NDT in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://renewable-energy-ndt.vercel.app/renewables/tidal-and-wave-energy-asset-inspection-introduction",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Tidal and Wave Energy Asset Inspection: An Introduction",
  "description": "Practical guide for wind: how to apply tidal energy NDT in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://renewable-energy-ndt.vercel.app/renewables/tidal-and-wave-energy-asset-inspection-introduction"
  },
  "keywords": "tidal energy NDT, wave energy inspection, marine renewable, MRE inspection"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Tidal and Wave Energy Asset Inspection: An Introduction</span>
      </nav>
      <h1>Tidal and Wave Energy Asset Inspection: An Introduction</h1>
      <p className="text-sm text-gray-500 mb-8">By Sven Mortensen, IIMS &middot; Published 2026-05-04</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions wind, solar, hydrogen, and geothermal NDT engineers need to make when working on renewable energy NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of tidal energy ndt that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any wind how often tidal energy ndt drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most tidal energy ndt programs disputes between QA, integrity, and operations.</li>
...
<p>The textbook approach to tidal energy ndt usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible tidal energy ndt report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of tidal energy ndt should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize tidal energy ndt in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p>
<p>Practical teams often cross-reference <a href="https://atlantisndt.com/erp/quality-management-for-marine-survey-companies" rel="noopener">Atlantis NDT's quality management for marine survey companies ERP write-up</a> to align their practice with what is already published in the wider community.</p><h3>How tidal energy NDT fits into the bigger picture</h3>
<p>It is easy to study tidal energy NDT as an isolated subject — most courses do exactly that — but the engineering value only appears when you place tidal energy NDT alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.asnt.org/" rel="noopener nofollow">ASNT (American Society for Nondestructive Testing)</a> to align their practice with what is already published in the wider community. For most wind the question is not "what is tidal energy NDT?" but "where does tidal energy NDT sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in tidal energy NDT, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on wave energy inspection</h3>
<p>Three behaviours we see at high-performing operators consistently show up in wave energy inspection programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a wave energy inspection program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best marine renewable documentation packages we have seen share three patterns:</p>
<ul>
...
<p>MRE inspection engagements have a recurring procurement pitfall: the scope of work is written in inspection-deliverable language ("ten welds inspected by PAUT"), and the contract success criteria are written in commercial language ("on time, on budget, no NCRs"). Neither captures the engineering outcome the asset owner actually needs, which is a defensible decision about fitness for service. Contracts that explicitly include a deliverable like "decision-grade report with Level III rationale signed and dated" align all three parties — owner, integrity engineer, and contractor — around the same outcome.</p>
