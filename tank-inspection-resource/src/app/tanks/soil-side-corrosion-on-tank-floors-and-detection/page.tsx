...
export const metadata: Metadata = {
  title: "Soil-Side Corrosion on Tank Floors and How to Detect It",
  description: "Practical guide for API 653 inspectors: how to apply soil side corrosion in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["soil side corrosion","tank floor underside","API 653 soil side","tank floor MFL"],
  alternates: { canonical: "https://tank-inspection-resource.vercel.app/tanks/soil-side-corrosion-on-tank-floors-and-detection" },
  openGraph: {
    title: "Soil-Side Corrosion on Tank Floors and How to Detect It",
    description: "Practical guide for API 653 inspectors: how to apply soil side corrosion in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://tank-inspection-resource.vercel.app/tanks/soil-side-corrosion-on-tank-floors-and-detection",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Soil-Side Corrosion on Tank Floors and How to Detect It",
  "description": "Practical guide for API 653 inspectors: how to apply soil side corrosion in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://tank-inspection-resource.vercel.app/tanks/soil-side-corrosion-on-tank-floors-and-detection"
  },
  "keywords": "soil side corrosion, tank floor underside, API 653 soil side, tank floor MFL"
};
...
<ul>
<li><strong>The decision points</strong> that drive most soil side corrosion programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any soil side corrosion engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible soil side corrosion report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of soil side corrosion should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize soil side corrosion in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How soil side corrosion fits into the bigger picture</h3>
<p>It is easy to study soil side corrosion as an isolated subject — most courses do exactly that — but the engineering value only appears when you place soil side corrosion alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iso.org/standard/55000" rel="noopener nofollow">ISO 55000 asset management family</a> to align their practice with what is already published in the wider community. For most API 653 inspectors the question is not "what is soil side corrosion?" but "where does soil side corrosion sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in soil side corrosion, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on tank floor underside</h3>
<p>Three behaviours we see at high-performing operators consistently show up in tank floor underside programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a tank floor underside program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best API 653 soil side documentation packages we have seen share three patterns:</p>
<ul>
