...
export const metadata: Metadata = {
  title: "Geothermal Well Casing Corrosion and Inspection Strategy",
  description: "Practical guide for wind: how to apply geothermal well in real inspection work, what auditors expect, and where most programs fall short.",
  keywords: ["geothermal well","casing inspection","geothermal corrosion","CO2 H2S well"],
  alternates: { canonical: "https://renewable-energy-ndt.vercel.app/renewables/geothermal-well-casing-corrosion-and-inspection" },
  openGraph: {
    title: "Geothermal Well Casing Corrosion and Inspection Strategy",
    description: "Practical guide for wind: how to apply geothermal well in real inspection work, what auditors expect, and where most programs fall short.",
    type: 'article',
    url: "https://renewable-energy-ndt.vercel.app/renewables/geothermal-well-casing-corrosion-and-inspection",
    siteName: "Renewable Energy NDT",
    locale: 'en_US',
    publishedTime: "2025-12-17T00:00:00.000Z",
    modifiedTime: "2025-12-17T00:00:00.000Z",
    authors: ["Lior Adani, Geothermal Eng"],
  },
};
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Geothermal Well Casing Corrosion and Inspection Strategy",
  "description": "Practical guide for wind: how to apply geothermal well in real inspection work, what auditors expect, and where most programs fall short.",
  "author": {
    "@type": "Person",
    "name": "Lior Adani, Geothermal Eng"
  },
  "publisher": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://renewable-energy-ndt.vercel.app/renewables/geothermal-well-casing-corrosion-and-inspection"
  },
  "keywords": "geothermal well, casing inspection, geothermal corrosion, CO2 H2S well"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Geothermal Well Casing Corrosion and Inspection Strategy</span>
      </nav>
      <h1>Geothermal Well Casing Corrosion and Inspection Strategy</h1>
      <p className="text-sm text-gray-500 mb-8">By Lior Adani, Geothermal Eng &middot; Published 2025-12-17</p>
      <div dangerouslySetInnerHTML={{ __html: `<p>This article walks through the practical decisions wind, solar, hydrogen, and geothermal NDT engineers need to make when working on renewable energy NDT. The goal is not theory — it is the kind of working knowledge an experienced inspector or engineer would share over a coffee on a job site, with enough rigor to point back to code and standard references when those decisions get challenged in audit. Throughout the piece we focus on the parts of geothermal well that turn into real schedule or budget pain when they go wrong.</p><h2>Why this comes up so often in the field</h2>
<p>Ask any wind how often geothermal well drives schedule pain and you will hear the same answer: more often than the project plan ever assumes. Part of the reason is that this kind of inspection sits at the intersection of multiple owners — operations, integrity, fabrication, and QA — and the ownership boundaries are rarely clean. When a problem surfaces, it is usually too late to plan; the team is already in execution mode and looking for guidance.</p>
...
<ul>
<li><strong>The decision points</strong> that drive most geothermal well programs disputes between QA, integrity, and operations.</li>
...
<p>Below is the working matrix our team uses on day one of any geothermal well engagement. It is deliberately simple because complexity here costs more than it saves.</p>
...
<p>The textbook approach to geothermal well usually points engineers at one or two techniques. The field reality is messier; the technique that ranks best on a comparison chart is often not the one that fits the access, the schedule, or the inspector skill mix actually available on the day. We walk through three patterns we see repeatedly.</p>
...
<p>Auditors do not argue with conclusions; they argue with the evidence behind them. For any defensible geothermal well report, the evidence packet needs to include at minimum:</p>
<ul>
...
<li><strong>Letting one inspector own the data interpretation alone.</strong> Interpretation of geothermal well should always have a second reviewer for any indication that drives a fitness or repair decision.</li>
...
<p>If we had to summarize geothermal well in one line it would be this: <strong>the technique matters less than the decision discipline around it.</strong> Teams that consistently choose the right technique are usually teams that have invested in writing down their decision rationale, qualifying their procedures with care, and keeping their inspectors current. Equipment and software change every few years; that discipline does not.</p><h3>How geothermal well fits into the bigger picture</h3>
<p>It is easy to study geothermal well as an isolated subject — most courses do exactly that — but the engineering value only appears when you place geothermal well alongside the other levers your program already uses. Practical teams often cross-reference <a href="https://www.iaea.org/topics/non-destructive-testing" rel="noopener nofollow">the IAEA non-destructive testing programme</a> to align their practice with what is already published in the wider community. For most wind the question is not "what is geothermal well?" but "where does geothermal well sit in our existing program, and what does it replace or complement?". That framing usually changes the procurement conversation, the training conversation, and the audit conversation in the same direction.</p>
<p>If your team is being asked to justify investment in geothermal well, the easiest place to start is a one-page side-by-side: current state, gap, expected uplift, and the specific risk ranking that improves. The numbers do not have to be precise; they have to be defensible.</p>
<h3>Operator behaviours that actually move the needle on casing inspection</h3>
<p>Three behaviours we see at high-performing operators consistently show up in casing inspection programs that are working: written rationale for every off-procedure decision; a standing peer-review for indications that drive a fitness call; and a quarterly close-out review where the integrity engineer and the inspection lead sit down with the raw data, not just the summary. None of these behaviours require new hardware. All three improve outcomes more than another tool purchase usually does.</p>
<p>What we do not see at high-performing operators is over-reliance on a single inspector or a single contractor. Cross-checking — even informally — is the cheapest insurance you can buy on a casing inspection program.</p>
<h3>Documentation patterns worth borrowing</h3>
<p>The best geothermal corrosion documentation packages we have seen share three patterns:</p>
<ul>
