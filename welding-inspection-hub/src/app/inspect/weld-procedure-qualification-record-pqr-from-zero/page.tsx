...
export const metadata: Metadata = {
  title: "Weld Procedure Qualification Record (PQR) From Zero",
  description: "Weld Procedure Qualification Record (PQR) From Zero explained for CWIs — covering PQR welding, common pitfalls, and the data your audit packet needs.",
  keywords: ["PQR welding","WPS PQR","ASME IX","welding qualification"],
  alternates: { canonical: "https://welding-inspection-hub.vercel.app/inspect/weld-procedure-qualification-record-pqr-from-zero" },
  openGraph: {
    title: "Weld Procedure Qualification Record (PQR) From Zero",
    description: "Weld Procedure Qualification Record (PQR) From Zero explained for CWIs — covering PQR welding, common pitfalls, and the data your audit packet needs.",
    type: 'article',
    url: "https://welding-inspection-hub.vercel.app/inspect/weld-procedure-qualification-record-pqr-from-zero",
...
const jsonLd = {
  ...
  "@type": "Article",
  "headline": "Weld Procedure Qualification Record (PQR) From Zero",
  "description": "Weld Procedure Qualification Record (PQR) From Zero explained for CWIs — covering PQR welding, common pitfalls, and the data your audit packet needs.",
  "author": {
    "@type": "Person",
  ...
  "dateModified": "2025-06-08T00:00:00.000Z",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://welding-inspection-hub.vercel.app/inspect/weld-procedure-qualification-record-pqr-from-zero"
  },
  "keywords": "PQR welding, WPS PQR, ASME IX, welding qualification"
};
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 prose prose-slate prose-lg">
      ...
      <nav className="breadcrumb text-sm text-gray-500 mb-6">
        ...
        <span> / </span>
        <span>Weld Procedure Qualification Record (PQR) From Zero</span>
      </nav>
      <h1>Weld Procedure Qualification Record (PQR) From Zero</h1>
      <p className="text-sm text-gray-500 mb-8">By Carlos Andrade, IWE &middot; Published 2025-06-08</p>
